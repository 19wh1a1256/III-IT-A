        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(name.getText().toString() != null && password.getText().toString() != null && address.getText().toString() != null && age.getText().toString() != null && gender != null && date != null) {
                    boolean isInserted = helperObj.insertdata(name.getText().toString(),password.getText().toString(),address.getText().toString(),gender,date,age.getText().toString());
                    if(isInserted) {
                        Toast.makeText(MainActivity.this, "Registration Successfull",
                                Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(MainActivity.this,"Enter details correctly",
                                Toast.LENGTH_SHORT).show();
                    }}else{
                    Toast.makeText(MainActivity.this,"Enter all the details",
                            Toast.LENGTH_SHORT).show();
                }}
        });
